...
class DataFrameOrdering:
    """
    Represents an ordered :class:`~dataframe.DataFrame` generated by
    ...
    def __getitem__(self, rows: slice) -> "DataFrame":
        """
        Returns a :class:`~dataframe.DataFrame` that contains the slice of dataframe in order.
    ...
    def dataframe(self) -> "DataFrame":
        """
        Returns :class:`~dataframe.DataFrame` associated for ORDER BY
