"""
This module creates a Python object OrderedDataFrame for order by dataframe.
"""
import sys
...
class OrderedDataFrame:
    ...
    :func:`DataFrame.order_by <dataframe.DataFrame.order_by>` or :func:`OrderedDataFrame.order_by`.
    """
