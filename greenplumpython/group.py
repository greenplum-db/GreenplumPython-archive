...
class DataFrameGroupingSets:
    """
    Represents a group of rows in a :class:`~dataframe.DataFrame` generated by
    ...
    def assign(self, **new_columns: Callable[["DataFrame"], Any]) -> "DataFrame":
        ...
        Returns:
            :class:`DataFrame` with the new columns.
    ...
    def dataframe(self) -> "DataFrame":
        """
        Returns :class:`~dataframe.DataFrame` associated for GROUP BY
