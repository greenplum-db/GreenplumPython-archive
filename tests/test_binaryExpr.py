...
def test_table_true_div(db: gp.Database):
    nums = db.make_table([(i,) for i in range(1, 10)], column_names=["num"])
...
def test_table_true_div_integers(db: gp.Database):
    nums = db.make_table([(i,) for i in range(4, 5)], column_names=["num"])
...
def test_table_true_div_integer_float(db: gp.Database):
    nums = db.make_table([(i,) for i in range(5, 8, 2)], column_names=["num"])
...
def test_table_true_div_zero(db: gp.Database):
    nums = db.make_table([(i,) for i in range(5)], column_names=["num"])
